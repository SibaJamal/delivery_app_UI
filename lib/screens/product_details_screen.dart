  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        children: [
          Padding(
            padding: EdgeInsets.only(bottom: 20.0.r,right: 20.0.r),
            child: IconButton(
              style: ButtonStyle(backgroundColor: WidgetStateProperty.resolveWith((state)=> state.contains(WidgetState.pressed)?Colors.black.withAlpha(90):Colors.white),elevation: WidgetStatePropertyAll(4),shadowColor: WidgetStatePropertyAll(Colors.black)),
